...
虚拟货币可选配 [CobbleDollars](https://modrinth.com/mod/cobbledollars) 或 [Impactor](https://modrinth.com/mod/impactor)；不装则使用物品货币（默认钻石）。**[Cobblemon Economy](https://modrinth.com/mod/cobblemon-economy) 暂时不受支持**（与 Cobblemon 1.8 不兼容），详见 [货币系统](/currency)。
